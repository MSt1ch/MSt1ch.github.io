...
$(function(){function o(o){$(document).scrollTop()>=800?$(".button_up").fadeIn("normal"):$(".button_up").fadeOut("normal")}$(document).ready(function(){$(".popup-with-form").magnificPopup({type:"inline",preloader:!1,focus:"#phone_number",callbacks:{beforeOpen:function(){$(window).width()<700?this.st.focus=!1:this.st.focus="#phone_number"}}})}),$(".owl-carousel._1").owlCarousel({Default:1,loop:!0,autoplay:!0,autoplayTimeout:5e3,smartSpeed:1500,autoHeight:!1,nav:!1,autoHeightClass:"owl-height",startPosition:2,responsive:{0:{items:1}}}),$(".owl-carousel._2").owlCarousel({Default:1,loop:!1,autoHeight:!1,nav:!0,navText:["<i class='fa fa-chevron-left'></i>","<i class='fa fa-chevron-right'></i>"],autoHeightClass:"owl-height",responsiveClass:!0,responsive:{0:{items:1}}}),$(".owl-carousel._1 .owl-dot").each(function(o){$(this).find("span").append(o+1)}),$(".owl-carousel._2 .owl-item").each(function(o,e){e=$(this).find("h4").html(),$(this).parents().find(".owl-carousel._2").find(".owl-dot").eq(o).find("span").append(e),console.log(e)}),$(window).resize(function(){$(".s_offer_item").css("height","auto"),$(".s_offer_item").equalHeights()}),$(".main_mnu ul a, .button_up").mPageScroll2id(),$(document).on("scroll",o),$("textarea").jqBootstrapValidation({submitSuccess:function(o,e){e.preventDefault();var t=$(".main_form").serialize();return $.ajax({type:"POST",url:"/mail.php",data:t}).done(function(){$(this).find("input").val(""),alert("Спасибо, мы обязательно свяжемся с Вами в ближайшее время!"),$(".main_form").trigger("reset")}),!1}})});